...
### [​](#agent-scoped-memory) Agent-scoped memory
...
### [​](#user-scoped-memory) User-scoped memory
...
### [​](#organization-level-memory) Organization-level memory
...
#### [​](#consolidation-agent) Consolidation agent
...
### [​](#read-only-vs-writable-memory) Read-only vs writable memory
...
### [​](#multiple-agents-in-the-same-deployment) Multiple agents in the same deployment
...
Previous](https://docs.langchain.com/oss/python/deepagents/permissions)[Skills

Next](https://docs.langchain.com/oss/python/deepagents/skills)
