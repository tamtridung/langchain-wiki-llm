...
[​](https://docs.langchain.com/oss/python/deepagents/sandboxes#why-use-sandboxes) Why use sandboxes?
----------------------------------------------------------------------------------------------------
...
**Using Deep Agents Code?** Deep Agents Code has built-in sandbox support via the `--sandbox` flag. See [Use remote sandboxes](https://docs.langchain.com/oss/python/deepagents/code/remote-sandboxes) for Deep Agents Code-specific setup, flags (`--sandbox-id`, `--sandbox-setup`), and examples.
...
[​](https://docs.langchain.com/oss/python/deepagents/sandboxes#basic-usage) Basic usage
---------------------------------------------------------------------------------------
...
Don’t see your provider? You can implement your own sandbox backend. See [Contributing a sandbox integration](https://docs.langchain.com/oss/python/contributing/integrations-langchain).

[​](https://docs.langchain.com/oss/python/deepagents/sandboxes#lifecycle-and-scoping) Lifecycle and scoping
-----------------------------------------------------------------------------------------------------------
...
### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#thread-scoped-default) Thread-scoped (default)
...
### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#assistant-scoped) Assistant-scoped
...
[​](https://docs.langchain.com/oss/python/deepagents/sandboxes#integration-patterns) Integration patterns
---------------------------------------------------------------------------------------------------------

There are two architecture patterns for integrating agents with sandboxes, based on where the agent runs.

### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#agent-in-sandbox-pattern) Agent in sandbox pattern
...
### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#sandbox-as-tool-pattern) Sandbox as tool pattern
...
[​](https://docs.langchain.com/oss/python/deepagents/sandboxes#how-sandboxes-work) How sandboxes work
-----------------------------------------------------------------------------------------------------

### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#isolation-boundaries) Isolation boundaries
...
### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#the-execute-method) The `execute` method
...
### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#two-planes-of-file-access) Two planes of file access
...
[​](https://docs.langchain.com/oss/python/deepagents/sandboxes#working-with-files) Working with files
-----------------------------------------------------------------------------------------------------

The deepagents sandbox backends support file transfer APIs for moving files between your application and the sandbox.

### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#seeding-the-sandbox) Seeding the sandbox
...
### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#retrieving-artifacts) Retrieving artifacts
...
[​](https://docs.langchain.com/oss/python/deepagents/sandboxes#security-considerations) Security considerations
---------------------------------------------------------------------------------------------------------------
...
### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#handling-secrets-safely) Handling secrets safely
...
### [​](https://docs.langchain.com/oss/python/deepagents/sandboxes#general-best-practices) General best practices
...
Previous](https://docs.langchain.com/oss/python/deepagents/skills)[Interpreters

Next](https://docs.langchain.com/oss/python/deepagents/interpreters)
