...
### [​](#config-declared-providers) Config-declared providers
...
[​](#param-supports-sandbox-id)

supports\_sandbox\_id
...
[​](#param-supports-snapshot-name)

supports\_snapshot\_name
...
Previous](https://docs.langchain.com/oss/python/deepagents/code/memory-and-skills)[Use subagents in Deep Agents Code

Next](https://docs.langchain.com/oss/python/deepagents/code/subagents)
