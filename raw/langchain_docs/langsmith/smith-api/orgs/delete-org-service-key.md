...
source: https://docs.langchain.com/langsmith/smith-api/orgs/delete-org-service-key.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/orgs/current/service-keys/{api_key_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/orgs/current/service-keys/{api_key_id}:
    delete:
      ...
      operationId: >-
        delete_org_service_key_api_v1_orgs_current_service_keys__api_key_id__delete
      parameters:
        - name: api_key_id
          in: path
          required: true
