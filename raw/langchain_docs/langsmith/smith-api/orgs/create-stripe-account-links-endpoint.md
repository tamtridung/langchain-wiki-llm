...
source: https://docs.langchain.com/langsmith/smith-api/orgs/create-stripe-account-links-endpoint.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/stripe_account_links
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/orgs/current/stripe_account_links:
    post:
      ...
      operationId: >-
        create_stripe_account_links_endpoint_api_v1_orgs_current_stripe_account_links_post
      requestBody:
        content:
          application/json:
            schema:
