...
source: https://docs.langchain.com/langsmith/smith-api/orgs/list-ttl-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/ttl-settings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/orgs/ttl-settings:
    get:
      ...
      description: >-
        List out the configured TTL settings for a given org (org-level and
        tenant-level).
