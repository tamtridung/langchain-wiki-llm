...
source: https://docs.langchain.com/langsmith/smith-api/orgs/list-organization-roles.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/current/roles
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
