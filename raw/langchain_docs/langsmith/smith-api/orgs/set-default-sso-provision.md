...
source: https://docs.langchain.com/langsmith/smith-api/orgs/set-default-sso-provision.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/set-default-sso-provision
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                type: object
                title: >-
                  Response Set Default Sso Provision Api V1 Orgs Current Set
                  Default Sso Provision Post
      security:
        - API Key: []
        - Organization ID: []
        - Bearer Auth: []
