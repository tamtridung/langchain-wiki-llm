...
source: https://docs.langchain.com/langsmith/smith-api/orgs/list-permissions.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/permissions
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
