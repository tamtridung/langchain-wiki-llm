...
source: https://docs.langchain.com/langsmith/smith-api/orgs/on-payment-method-created.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/payment-method
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
