...
source: https://docs.langchain.com/langsmith/smith-api/orgs/update-current-user.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /api/v1/orgs/members/basic
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
