...
source: https://docs.langchain.com/langsmith/smith-api/orgs/list-org-personal-access-tokens.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/current/personal-access-tokens
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/orgs/current/personal-access-tokens:
    get:
      ...
      operationId: >-
        list_org_personal_access_tokens_api_v1_orgs_current_personal_access_tokens_get
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                ...
                type: array
                title: >-
                  Response List Org Personal Access Tokens Api V1 Orgs Current
