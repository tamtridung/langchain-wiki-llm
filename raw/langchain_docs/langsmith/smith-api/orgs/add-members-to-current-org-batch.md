...
source: https://docs.langchain.com/langsmith/smith-api/orgs/add-members-to-current-org-batch.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/members/batch
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                type: array
                title: >-
                  Response Add Members To Current Org Batch Api V1 Orgs Current
                  Members Batch Post
        '422':
