---
title: Get Org Usage
source: https://docs.langchain.com/langsmith/smith-api/orgs/get-org-usage.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/current/billing/usage
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
