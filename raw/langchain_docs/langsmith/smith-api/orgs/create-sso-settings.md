...
source: https://docs.langchain.com/langsmith/smith-api/orgs/create-sso-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/sso-settings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
