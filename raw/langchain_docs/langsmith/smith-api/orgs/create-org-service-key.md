...
source: https://docs.langchain.com/langsmith/smith-api/orgs/create-org-service-key.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/service-keys
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
