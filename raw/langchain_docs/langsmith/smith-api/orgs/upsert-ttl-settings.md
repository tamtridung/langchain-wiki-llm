...
source: https://docs.langchain.com/langsmith/smith-api/orgs/upsert-ttl-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json put /api/v1/orgs/ttl-settings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
