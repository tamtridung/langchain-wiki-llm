...
source: https://docs.langchain.com/langsmith/smith-api/orgs/get-current-pending-org-members.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/current/members/pending
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Get Current Pending Org Members Api V1 Orgs Current
                  Members Pending Get
        '422':
