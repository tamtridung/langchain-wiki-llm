...
source: https://docs.langchain.com/langsmith/smith-api/orgs/get-organization-info.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/current
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
