...
source: https://docs.langchain.com/langsmith/smith-api/orgs/create-customers-and-get-stripe-setup-intent.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/setup
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/orgs/current/setup:
    post:
      ...
      operationId: >-
        create_customers_and_get_stripe_setup_intent_api_v1_orgs_current_setup_post
      responses:
        '200':
