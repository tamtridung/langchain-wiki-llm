...
source: https://docs.langchain.com/langsmith/smith-api/orgs/delete-sso-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/orgs/current/sso-settings/{id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
