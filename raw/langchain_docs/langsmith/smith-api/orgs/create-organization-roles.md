...
source: https://docs.langchain.com/langsmith/smith-api/orgs/create-organization-roles.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/roles
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
