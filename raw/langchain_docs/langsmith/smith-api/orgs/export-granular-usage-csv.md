...
source: https://docs.langchain.com/langsmith/smith-api/orgs/export-granular-usage-csv.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/current/billing/granular-usage/export
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /api/v1/orgs/current/billing/granular-usage/export:
    get:
      ...
      description: |-
        ...
        Dimension columns are identical across kinds.
      operationId: >-
        export_granular_usage_csv_api_v1_orgs_current_billing_granular_usage_export_get
      parameters:
        - name: start_time
          in: query
          required: true
