...
source: https://docs.langchain.com/langsmith/smith-api/orgs/change-payment-plan.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/plan
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
components:
  schemas:
    ...
    ChangePaymentPlanReq:
      ...
      description: >-
        Enum for payment plans that the user can change to. Developer plans are
        permanent and enterprise plans will be changed manually.
    ValidationError:
      properties:
        loc:
          items:
