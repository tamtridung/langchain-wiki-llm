...
source: https://docs.langchain.com/langsmith/smith-api/orgs/set-company-info.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/business-info
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
