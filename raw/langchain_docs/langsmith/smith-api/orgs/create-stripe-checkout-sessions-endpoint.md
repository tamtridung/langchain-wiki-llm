...
source: https://docs.langchain.com/langsmith/smith-api/orgs/create-stripe-checkout-sessions-endpoint.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/orgs/current/stripe_checkout_session
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/orgs/current/stripe_checkout_session:
    post:
      ...
      operationId: >-
        create_stripe_checkout_sessions_endpoint_api_v1_orgs_current_stripe_checkout_session_post
      requestBody:
        content:
          application/json:
            schema:
