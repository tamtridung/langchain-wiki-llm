---
title: Get Dashboard
source: https://docs.langchain.com/langsmith/smith-api/orgs/get-dashboard.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/orgs/current/dashboard
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
