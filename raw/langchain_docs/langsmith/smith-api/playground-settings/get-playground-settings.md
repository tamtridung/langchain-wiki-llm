...
source: https://docs.langchain.com/langsmith/smith-api/playground-settings/get-playground-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/playground-settings/{playground_settings_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/playground-settings/{playground_settings_id}:
    get:
      tags:
        - playground-settings
      summary: Get Playground Settings
      description: Get a single playground settings by ID.
      operationId: >-
        get_playground_settings_api_v1_playground_settings__playground_settings_id__get
      parameters:
