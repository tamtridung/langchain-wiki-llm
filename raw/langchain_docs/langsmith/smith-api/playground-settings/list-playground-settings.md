...
source: https://docs.langchain.com/langsmith/smith-api/playground-settings/list-playground-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/playground-settings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                type: array
                title: >-
                  Response List Playground Settings Api V1 Playground Settings
                  Get
      security:
        - API Key: []
        - Tenant ID: []
