...
source: https://docs.langchain.com/langsmith/smith-api/playground-settings/create-playground-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/playground-settings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
