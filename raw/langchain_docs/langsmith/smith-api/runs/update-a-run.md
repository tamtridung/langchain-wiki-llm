---
title: Update a Run
source: https://docs.langchain.com/langsmith/smith-api/runs/update-a-run.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /runs/{run_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /runs/{run_id}:
    patch:
      ...
      description: >-
        Updates a run identified by its ID. The body should contain only the
        fields to be changed; unknown fields are ignored.
      parameters:
        - description: Run ID
          name: run_id
          in: path
