...
source: https://docs.langchain.com/langsmith/smith-api/runs/ingest-runs-batch-json.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /runs/batch
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /runs/batch:
    post:
      ...
      description: >-
        ...
        of runs, but `/runs/multipart` offers better handling for very large
