...
source: https://docs.langchain.com/langsmith/smith-api/directories/create-directory-commit.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /v1/platform/hub/repos/{owner}/{repo}/directories/commits
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
tags:
  ...
  - name: fleet users
paths:
  /v1/platform/hub/repos/{owner}/{repo}/directories/commits:
    post:
      tags:
        - directories
