...
source: https://docs.langchain.com/langsmith/smith-api/bulk-exports/get-bulk-export-runs-filtered.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/bulk-exports/runs
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/bulk-exports/runs:
    get:
      ...
      description: >-
        Get all bulk export runs for exports that were created from a scheduled
        bulk export
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Get Bulk Export Runs Filtered Api V1 Bulk Exports
                  Runs Get
        '422':
