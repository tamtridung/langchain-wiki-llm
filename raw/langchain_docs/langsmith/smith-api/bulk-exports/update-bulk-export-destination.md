...
source: https://docs.langchain.com/langsmith/smith-api/bulk-exports/update-bulk-export-destination.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /api/v1/bulk-exports/destinations/{destination_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/bulk-exports/destinations/{destination_id}:
    patch:
      ...
      operationId: >-
        update_bulk_export_destination_api_v1_bulk_exports_destinations__destination_id__patch
      parameters:
        - name: destination_id
          in: path
          required: true
