---
title: Create Bulk Export
source: https://docs.langchain.com/langsmith/smith-api/bulk-exports/create-bulk-export.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/bulk-exports
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
