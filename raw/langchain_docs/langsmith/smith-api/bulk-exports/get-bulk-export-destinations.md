...
source: https://docs.langchain.com/langsmith/smith-api/bulk-exports/get-bulk-export-destinations.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/bulk-exports/destinations
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                type: array
                title: >-
                  Response Get Bulk Export Destinations Api V1 Bulk Exports
                  Destinations Get
      security:
        - API Key: []
        - Tenant ID: []
