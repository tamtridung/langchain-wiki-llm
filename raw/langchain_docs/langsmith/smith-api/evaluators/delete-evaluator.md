...
source: https://docs.langchain.com/langsmith/smith-api/evaluators/delete-evaluator.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /v1/platform/evaluators/{evaluator_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /v1/platform/evaluators/{evaluator_id}:
    delete:
      ...
      description: >-
        Delete an evaluator. When delete_run_rules is true, all run rules
        referencing this evaluator are deleted first (same tenant). Associated
        llm_evaluators and code_evaluators rows are removed by foreign-key
