...
source: https://docs.langchain.com/langsmith/smith-api/evaluators/create-evaluator.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /v1/platform/evaluators
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
    ...
    post:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/evaluators.CreateEvaluatorRequest'
      responses:
        '201':
          description: Created
          content:
...
components:
  schemas:
    evaluators.CreateEvaluatorRequest:
      ...
      properties:
        code_evaluator:
          $ref: '#/components/schemas/evaluators.CreateCodeEvaluatorRequest'
        llm_evaluator:
          $ref: '#/components/schemas/evaluators.CreateLLMEvaluatorRequest'
        name:
          type: string
        type:
          $ref: '#/components/schemas/evaluators.EvaluatorType'
    evaluators.CreateEvaluatorResponse:
      type: object
      properties:
        evaluator:
    ...
    evaluators.ErrorResponse:
      ...
      properties:
        error:
          ...
          type: string
    evaluators.CreateCodeEvaluatorRequest:
      type: object
      properties:
        code:
          type: string
        language:
          ...
          type: string
    evaluators.CreateLLMEvaluatorRequest:
      type: object
      properties:
        commit_hash_or_tag:
          type: string
