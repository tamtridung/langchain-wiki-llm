...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/get-sandbox-resource-usage.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /v2/sandboxes/usage
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /v2/sandboxes/usage:
    get:
      tags:
        - sandboxes
      summary: Get sandbox resource usage
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/sandboxes.UsageResponse'
        '500':
