...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/execute-a-sandbox-command.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /v2/sandboxes/{sandbox_id}/execute
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
tags:
  ...
  - name: fleet users
paths:
  /v2/sandboxes/{sandbox_id}/execute:
    post:
      tags:
        - sandboxes
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/sandboxes.ExecRequest'
      responses:
        '200':
          description: OK
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/sandboxes.ExecResponse'
        '400':
