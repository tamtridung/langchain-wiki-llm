...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/download-a-sandbox-file.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /v2/sandboxes/{sandbox_id}/download
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
tags:
  ...
  - name: fleet users
paths:
  /v2/sandboxes/{sandbox_id}/download:
    get:
      tags:
        - sandboxes
      summary: Download a sandbox file
      description: Download file contents from a sandbox filesystem path.
      parameters:
