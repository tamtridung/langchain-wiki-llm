...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/get-a-snapshot.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /v2/sandboxes/snapshots/{snapshot_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /v2/sandboxes/snapshots/{snapshot_id}:
    get:
      ...
      description: Get a sandbox snapshot by ID.
      parameters:
