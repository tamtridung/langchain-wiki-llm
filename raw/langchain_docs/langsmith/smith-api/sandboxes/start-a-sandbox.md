...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/start-a-sandbox.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /v2/sandboxes/boxes/{name}/start
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
