...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/get-sandbox-status.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /v2/sandboxes/boxes/{name}/status
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/sandboxes.SandboxStatusResponse'
        '404':
