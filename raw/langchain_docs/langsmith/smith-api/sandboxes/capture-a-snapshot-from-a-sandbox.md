...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/capture-a-snapshot-from-a-sandbox.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /v2/sandboxes/boxes/{name}/snapshot
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
tags:
  ...
  - name: fleet users
paths:
  /v2/sandboxes/boxes/{name}/snapshot:
    post:
      tags:
        - sandboxes
