...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/update-a-sandbox.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /v2/sandboxes/boxes/{name}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
    ...
    patch:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/sandboxes.UpdateSandboxPayload'
      responses:
        '200':
          description: OK
          content:
...
components:
  schemas:
    sandboxes.UpdateSandboxPayload:
      type: object
      properties:
