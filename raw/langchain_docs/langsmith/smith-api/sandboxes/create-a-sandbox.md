...
source: https://docs.langchain.com/langsmith/smith-api/sandboxes/create-a-sandbox.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /v2/sandboxes/boxes
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /v2/sandboxes/boxes:
    post:
      ...
      description: >-
        ...
        uses the default static blueprint.
      parameters: []
      requestBody:
        required: true
        content:
