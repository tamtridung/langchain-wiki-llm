---
title: Trigger Rule
source: https://docs.langchain.com/langsmith/smith-api/run/trigger-rule.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/runs/rules/{rule_id}/trigger
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
