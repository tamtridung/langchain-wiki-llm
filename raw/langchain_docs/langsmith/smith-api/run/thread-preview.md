...
source: https://docs.langchain.com/langsmith/smith-api/run/thread-preview.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/runs/threads/{thread_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
