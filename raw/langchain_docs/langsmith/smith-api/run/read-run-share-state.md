...
source: https://docs.langchain.com/langsmith/smith-api/run/read-run-share-state.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/runs/{run_id}/share
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
