...
source: https://docs.langchain.com/langsmith/smith-api/run/list-rule-logs.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/runs/rules/{rule_id}/logs
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
