...
source: https://docs.langchain.com/langsmith/smith-api/run/generate-query-for-runs.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/runs/generate-query
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
