---
title: Create Tag
source: https://docs.langchain.com/langsmith/smith-api/tags/create-tag.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/repos/{owner}/{repo}/tags
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/repos/{owner}/{repo}/tags:
    post:
      ...
      summary: Create Tag
      description: >-
        Create a tag. Requires repo ownership, prompts:tag permission, or ABAC
        grant.
