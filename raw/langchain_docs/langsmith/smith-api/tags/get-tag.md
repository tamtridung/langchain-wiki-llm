---
title: Get Tag
source: https://docs.langchain.com/langsmith/smith-api/tags/get-tag.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/repos/{owner}/{repo}/tags/{tag_name}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
