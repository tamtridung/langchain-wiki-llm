---
title: Update Tag
source: https://docs.langchain.com/langsmith/smith-api/tags/update-tag.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /api/v1/repos/{owner}/{repo}/tags/{tag_name}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/repos/{owner}/{repo}/tags/{tag_name}:
    patch:
      ...
      summary: Update Tag
      description: >-
        Update a tag. Requires repo ownership, prompts:tag permission, or ABAC
        grant.
