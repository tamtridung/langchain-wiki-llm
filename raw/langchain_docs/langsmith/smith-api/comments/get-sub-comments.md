...
source: https://docs.langchain.com/langsmith/smith-api/comments/get-sub-comments.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/comments/{owner}/{repo}/{parent_comment_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
