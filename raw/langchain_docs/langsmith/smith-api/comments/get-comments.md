---
title: Get Comments
source: https://docs.langchain.com/langsmith/smith-api/comments/get-comments.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/comments/{owner}/{repo}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
