...
source: https://docs.langchain.com/langsmith/smith-api/me/create-onboarding-state.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/me/onboarding_state
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
