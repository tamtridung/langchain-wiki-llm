...
source: https://docs.langchain.com/langsmith/smith-api/me/update-onboarding-state-field.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json put /api/v1/me/onboarding_state/{field}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
