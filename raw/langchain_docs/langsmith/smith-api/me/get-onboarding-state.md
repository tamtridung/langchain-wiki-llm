...
source: https://docs.langchain.com/langsmith/smith-api/me/get-onboarding-state.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/me/onboarding_state
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
