...
source: https://docs.langchain.com/langsmith/smith-api/me/get-the-authenticated-users-provider-user-id.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /me/providers/{providerType}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /me/providers/{providerType}:
    get:
      ...
      description: >-
        Returns the provider user ID associated with the authenticated user for
        a given provider type, or null if not set. Scoped to the current tenant.
      parameters:
