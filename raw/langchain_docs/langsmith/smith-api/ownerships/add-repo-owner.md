...
source: https://docs.langchain.com/langsmith/smith-api/ownerships/add-repo-owner.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/repos/{owner}/{repo}/owners
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
