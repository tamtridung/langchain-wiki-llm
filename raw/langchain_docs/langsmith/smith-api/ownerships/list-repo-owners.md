...
source: https://docs.langchain.com/langsmith/smith-api/ownerships/list-repo-owners.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/repos/{owner}/{repo}/owners
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
