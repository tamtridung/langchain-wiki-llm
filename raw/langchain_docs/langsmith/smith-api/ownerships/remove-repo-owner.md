...
source: https://docs.langchain.com/langsmith/smith-api/ownerships/remove-repo-owner.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/repos/{owner}/{repo}/owners
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
