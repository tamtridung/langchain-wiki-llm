...
source: https://docs.langchain.com/langsmith/smith-api/model-price-map/update-model-price.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json put /api/v1/model-price-map/{id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
