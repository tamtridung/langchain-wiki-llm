...
source: https://docs.langchain.com/langsmith/smith-api/model-price-map/create-new-model-price.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/model-price-map
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
