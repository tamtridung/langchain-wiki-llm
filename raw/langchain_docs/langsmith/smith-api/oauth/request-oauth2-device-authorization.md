...
source: https://docs.langchain.com/langsmith/smith-api/oauth/request-oauth2-device-authorization.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /oauth/device/code
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /oauth/device/code:
    post:
      ...
      description: >-
        Issues a device code and user code for the device authorization flow per
        RFC 8628.
      parameters: []
      requestBody:
        required: true
