...
source: https://docs.langchain.com/langsmith/smith-api/oauth/exchange-grant-for-oauth2-tokens.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /oauth/token
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /oauth/token:
    post:
      ...
      description: >-
        Token endpoint that dispatches by grant_type: authorization_code,
              ...
              properties:
                grant_type:
                  ...
                  description: >-
                    ...
                    urn:ietf:params:oauth:grant-type:device_code, or
                    refresh_token
                client_id:
                  type: string
