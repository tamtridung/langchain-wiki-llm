...
source: https://docs.langchain.com/langsmith/smith-api/oauth/authorize-a-device-code.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /oauth/device/authorize
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /oauth/device/authorize:
    post:
      ...
      description: >-
        Marks a device code as authorized for the authenticated user. Called by
        the /activate page when the user enters their user code. Requires
        authentication.
      parameters: []
      requestBody:
        required: true
