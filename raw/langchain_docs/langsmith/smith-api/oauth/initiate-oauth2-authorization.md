...
source: https://docs.langchain.com/langsmith/smith-api/oauth/initiate-oauth2-authorization.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /oauth/authorize
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /oauth/authorize:
    get:
      ...
      description: >-
        Validates authorization request parameters and redirects to the frontend
        consent page per RFC 6749.
      parameters:
