...
source: https://docs.langchain.com/langsmith/smith-api/oauth/revoke-an-oauth2-token.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /oauth/revoke
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /oauth/revoke:
    post:
      ...
      description: >-
        ...
        200 regardless of whether the token was found.
      parameters: []
      requestBody:
        required: true
        content:
