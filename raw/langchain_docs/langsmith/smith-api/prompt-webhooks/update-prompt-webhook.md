...
source: https://docs.langchain.com/langsmith/smith-api/prompt-webhooks/update-prompt-webhook.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /api/v1/prompt-webhooks/{webhook_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
