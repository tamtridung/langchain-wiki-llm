...
source: https://docs.langchain.com/langsmith/smith-api/prompt-webhooks/delete-prompt-webhook.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/prompt-webhooks/{webhook_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
