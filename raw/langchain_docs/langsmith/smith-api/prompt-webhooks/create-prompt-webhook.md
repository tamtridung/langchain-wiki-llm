...
source: https://docs.langchain.com/langsmith/smith-api/prompt-webhooks/create-prompt-webhook.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/prompt-webhooks
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
