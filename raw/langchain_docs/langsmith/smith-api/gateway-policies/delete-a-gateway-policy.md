...
source: https://docs.langchain.com/langsmith/smith-api/gateway-policies/delete-a-gateway-policy.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /v1/platform/gateway-policies/{id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
