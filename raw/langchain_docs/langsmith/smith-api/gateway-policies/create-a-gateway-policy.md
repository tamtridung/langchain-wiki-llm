...
source: https://docs.langchain.com/langsmith/smith-api/gateway-policies/create-a-gateway-policy.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /v1/platform/gateway-policies
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /v1/platform/gateway-policies:
    post:
      ...
      responses:
        ...
        '400':
          description: >-
            validation failure (bad matchers, unknown policy_type, missing
            required field)
          content:
            application/json:
              schema:
