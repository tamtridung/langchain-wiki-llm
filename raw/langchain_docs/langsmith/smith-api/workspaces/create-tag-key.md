...
source: https://docs.langchain.com/langsmith/smith-api/workspaces/create-tag-key.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/workspaces/current/tag-keys
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
