...
source: https://docs.langchain.com/langsmith/smith-api/workspaces/add-members-to-current-workspace-batch.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/workspaces/current/members/batch
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
