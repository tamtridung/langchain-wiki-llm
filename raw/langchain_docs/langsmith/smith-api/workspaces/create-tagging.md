...
source: https://docs.langchain.com/langsmith/smith-api/workspaces/create-tagging.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/workspaces/current/taggings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
