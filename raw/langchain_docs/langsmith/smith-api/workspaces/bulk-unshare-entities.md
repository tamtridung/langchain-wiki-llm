...
source: https://docs.langchain.com/langsmith/smith-api/workspaces/bulk-unshare-entities.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/workspaces/current/shared
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
