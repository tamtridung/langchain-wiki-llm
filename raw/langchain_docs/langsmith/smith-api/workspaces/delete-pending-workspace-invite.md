...
source: https://docs.langchain.com/langsmith/smith-api/workspaces/delete-pending-workspace-invite.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/workspaces/pending/{id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
