...
source: https://docs.langchain.com/langsmith/smith-api/workspaces/add-member-to-current-workspace.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/workspaces/current/members
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
