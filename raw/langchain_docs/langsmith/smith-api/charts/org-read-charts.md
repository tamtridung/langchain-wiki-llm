---
title: Org Read Charts
source: https://docs.langchain.com/langsmith/smith-api/charts/org-read-charts.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/org-charts
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
