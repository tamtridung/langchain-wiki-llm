---
title: Org Read Chart Preview
source: https://docs.langchain.com/langsmith/smith-api/charts/org-read-chart-preview.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/org-charts/preview
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  schemas:
    ...
    CustomChartCreatePreview:
      properties:
        series:
          items:
            $ref: '#/components/schemas/CustomChartSeries-Input'
          type: array
          title: Series
        common_filters:
          anyOf:
