---
title: Clone Section
source: https://docs.langchain.com/langsmith/smith-api/charts/clone-section.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/charts/section/clone
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
