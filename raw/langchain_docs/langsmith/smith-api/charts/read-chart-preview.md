...
source: https://docs.langchain.com/langsmith/smith-api/charts/read-chart-preview.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/charts/preview
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
