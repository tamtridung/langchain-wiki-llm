...
source: https://docs.langchain.com/langsmith/smith-api/charts/org-read-sections.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/org-charts/section
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
