...
source: https://docs.langchain.com/langsmith/smith-api/charts/org-create-chart.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/org-charts/create
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
