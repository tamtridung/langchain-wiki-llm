---
title: Org Update Chart
source: https://docs.langchain.com/langsmith/smith-api/charts/org-update-chart.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /api/v1/org-charts/{chart_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
