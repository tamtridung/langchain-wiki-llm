...
source: https://docs.langchain.com/langsmith/smith-api/feedback/create-feedback-formula-ep.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/feedback/formulas
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
    ...
    post:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/FeedbackFormulaCreate'
      responses:
        '200':
