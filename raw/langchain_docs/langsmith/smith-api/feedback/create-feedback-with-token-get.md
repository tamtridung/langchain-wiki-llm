...
source: https://docs.langchain.com/langsmith/smith-api/feedback/create-feedback-with-token-get.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/feedback/tokens/{token}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
        ...
        - name: score
          ...
          schema:
            anyOf:
              ...
              - type: 'null'
            title: Score
        - name: do_not_extend_trace_retention
          in: query
          required: false
          schema:
            type: boolean
