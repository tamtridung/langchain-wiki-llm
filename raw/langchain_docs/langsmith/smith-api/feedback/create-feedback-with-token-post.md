...
source: https://docs.langchain.com/langsmith/smith-api/feedback/create-feedback-with-token-post.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/feedback/tokens/{token}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
