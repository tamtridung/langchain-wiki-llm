---
title: Read Feedback
source: https://docs.langchain.com/langsmith/smith-api/feedback/read-feedback.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/feedback/{feedback_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
