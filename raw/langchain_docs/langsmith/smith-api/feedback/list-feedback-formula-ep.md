...
source: https://docs.langchain.com/langsmith/smith-api/feedback/list-feedback-formula-ep.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/feedback/formulas
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
