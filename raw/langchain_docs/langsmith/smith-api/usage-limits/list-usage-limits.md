...
source: https://docs.langchain.com/langsmith/smith-api/usage-limits/list-usage-limits.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/usage-limits
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
