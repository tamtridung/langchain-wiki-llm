...
source: https://docs.langchain.com/langsmith/smith-api/usage-limits/upsert-usage-limit.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json put /api/v1/usage-limits
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
