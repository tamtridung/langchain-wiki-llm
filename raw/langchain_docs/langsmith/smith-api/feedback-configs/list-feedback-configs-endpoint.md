...
source: https://docs.langchain.com/langsmith/smith-api/feedback-configs/list-feedback-configs-endpoint.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/feedback-configs
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response List Feedback Configs Endpoint Api V1 Feedback
                  Configs Get
        '422':
