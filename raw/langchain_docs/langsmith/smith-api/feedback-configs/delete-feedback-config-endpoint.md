...
source: https://docs.langchain.com/langsmith/smith-api/feedback-configs/delete-feedback-config-endpoint.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/feedback-configs
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /api/v1/feedback-configs:
    delete:
      ...
      description: >-
        ...
        The config can be recreated later with the same key (simple reuse
        pattern).
