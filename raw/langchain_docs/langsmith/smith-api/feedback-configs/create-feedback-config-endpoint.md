...
source: https://docs.langchain.com/langsmith/smith-api/feedback-configs/create-feedback-config-endpoint.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/feedback-configs
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
