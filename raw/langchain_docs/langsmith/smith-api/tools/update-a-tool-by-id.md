...
source: https://docs.langchain.com/langsmith/smith-api/tools/update-a-tool-by-id.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /v1/platform/tools/id/{id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
