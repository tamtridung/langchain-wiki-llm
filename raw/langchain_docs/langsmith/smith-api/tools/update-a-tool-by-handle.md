...
source: https://docs.langchain.com/langsmith/smith-api/tools/update-a-tool-by-handle.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /v1/platform/tools/{handle}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
