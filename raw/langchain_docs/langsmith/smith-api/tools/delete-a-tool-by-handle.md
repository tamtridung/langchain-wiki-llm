...
source: https://docs.langchain.com/langsmith/smith-api/tools/delete-a-tool-by-handle.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /v1/platform/tools/{handle}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
