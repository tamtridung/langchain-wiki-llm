...
source: https://docs.langchain.com/langsmith/smith-api/tools/delete-a-tool-by-id.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /v1/platform/tools/id/{id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
