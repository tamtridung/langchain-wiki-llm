...
source: https://docs.langchain.com/langsmith/smith-api/service-accounts/create-service-account.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/service-accounts
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
