...
source: https://docs.langchain.com/langsmith/smith-api/service-accounts/get-service-accounts.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/service-accounts
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
