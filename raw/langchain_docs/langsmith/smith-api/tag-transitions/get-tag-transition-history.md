...
source: https://docs.langchain.com/langsmith/smith-api/tag-transitions/get-tag-transition-history.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /repos/{owner}/{repo}/tags/{tag_name}/history
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
        ...
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: >-
                  #/components/schemas/tag_transitions.TagTransitionHistoryResponse
        '400':
