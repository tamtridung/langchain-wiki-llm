---
title: Generate
source: https://docs.langchain.com/langsmith/smith-api/datasets/generate.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/datasets/{dataset_id}/generate
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
