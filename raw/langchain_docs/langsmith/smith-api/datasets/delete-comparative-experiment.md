...
source: https://docs.langchain.com/langsmith/smith-api/datasets/delete-comparative-experiment.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/datasets/comparative/{comparative_experiment_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/datasets/comparative/{comparative_experiment_id}:
    delete:
      ...
      operationId: >-
        delete_comparative_experiment_api_v1_datasets_comparative__comparative_experiment_id__delete
      parameters:
