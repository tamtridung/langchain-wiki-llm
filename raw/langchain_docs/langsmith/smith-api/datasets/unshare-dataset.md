...
source: https://docs.langchain.com/langsmith/smith-api/datasets/unshare-dataset.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/datasets/{dataset_id}/share
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
