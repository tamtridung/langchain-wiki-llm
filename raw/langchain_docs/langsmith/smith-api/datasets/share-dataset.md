---
title: Share Dataset
source: https://docs.langchain.com/langsmith/smith-api/datasets/share-dataset.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json put /api/v1/datasets/{dataset_id}/share
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
