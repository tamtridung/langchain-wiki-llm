...
source: https://docs.langchain.com/langsmith/smith-api/datasets/read-dataset-share-state.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/datasets/{dataset_id}/share
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
            ...
            application/json:
              schema:
                anyOf:
                  ...
                  - type: 'null'
                title: >-
                  Response Read Dataset Share State Api V1 Datasets  Dataset Id 
                  Share Get
        '422':
