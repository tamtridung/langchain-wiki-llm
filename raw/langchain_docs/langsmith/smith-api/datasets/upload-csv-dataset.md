...
source: https://docs.langchain.com/langsmith/smith-api/datasets/upload-csv-dataset.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/datasets/upload
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
      ...
      requestBody:
        content:
          multipart/form-data:
            schema:
              $ref: >-
                #/components/schemas/Body_upload_csv_dataset_api_v1_datasets_upload_post
        required: true
      responses:
        '200':
