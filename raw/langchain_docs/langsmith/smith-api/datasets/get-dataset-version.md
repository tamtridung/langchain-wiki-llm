...
source: https://docs.langchain.com/langsmith/smith-api/datasets/get-dataset-version.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/datasets/{dataset_id}/version
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
