...
source: https://docs.langchain.com/langsmith/smith-api/datasets/update-dataset-splits.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json put /api/v1/datasets/{dataset_id}/splits
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: >-
                #/components/schemas/Body_update_dataset_splits_api_v1_datasets__dataset_id__splits_put
      responses:
        '200':
            ...
            application/json:
              schema:
                ...
                items:
                  ...
                  format: uuid
                title: >-
                  Response Update Dataset Splits Api V1 Datasets  Dataset Id 
                  Splits Put
        '422':
