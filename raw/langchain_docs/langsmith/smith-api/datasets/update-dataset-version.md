...
source: https://docs.langchain.com/langsmith/smith-api/datasets/update-dataset-version.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json put /api/v1/datasets/{dataset_id}/tags
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
