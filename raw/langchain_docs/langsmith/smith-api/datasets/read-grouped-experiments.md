---
title: Read Grouped Experiments
source: https://docs.langchain.com/langsmith/smith-api/datasets/read-grouped-experiments.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/datasets/{dataset_id}/experiments/grouped
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/datasets/{dataset_id}/experiments/grouped:
    post:
      ...
      operationId: >-
        read_grouped_experiments_api_v1_datasets__dataset_id__experiments_grouped_post
      parameters:
        - name: dataset_id
          in: path
          required: true
