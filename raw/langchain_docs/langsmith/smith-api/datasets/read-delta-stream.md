...
source: https://docs.langchain.com/langsmith/smith-api/datasets/read-delta-stream.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/datasets/{dataset_id}/runs/delta/stream
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
