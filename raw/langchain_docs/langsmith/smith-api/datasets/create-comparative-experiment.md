...
source: https://docs.langchain.com/langsmith/smith-api/datasets/create-comparative-experiment.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/datasets/comparative
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
