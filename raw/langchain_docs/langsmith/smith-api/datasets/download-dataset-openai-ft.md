...
source: https://docs.langchain.com/langsmith/smith-api/datasets/download-dataset-openai-ft.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/datasets/{dataset_id}/openai_ft
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
