...
source: https://docs.langchain.com/langsmith/smith-api/datasets/get-dataset-versions.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/datasets/{dataset_id}/versions
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Get Dataset Versions Api V1 Datasets  Dataset Id 
                  Versions Get
        '422':
