...
source: https://docs.langchain.com/langsmith/smith-api/examples/upload-examples-from-csv.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/examples/upload/{dataset_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
  ...
  /api/v1/examples/upload/{dataset_id}:
    post:
      ...
      description: >-
        ...
        the POST /v1/platform/datasets/{dataset_id}/examples endpoint which
        provides more efficient upload.
      ...
      requestBody:
        ...
        content:
          multipart/form-data:
            schema:
              $ref: >-
                #/components/schemas/Body_upload_examples_from_csv_api_v1_examples_upload__dataset_id__post
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Upload Examples From Csv Api V1 Examples Upload 
                  Dataset Id  Post
        '422':
