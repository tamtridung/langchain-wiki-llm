...
source: https://docs.langchain.com/langsmith/smith-api/examples/create-examples.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/examples/bulk
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          application/json:
            schema:
              items:
                ...
                description: >-
                  Example with optional created_at to prevent duplicate versions
                  in bulk operations.
              type: array
