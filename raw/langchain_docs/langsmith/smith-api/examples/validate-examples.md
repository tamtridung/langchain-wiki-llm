...
source: https://docs.langchain.com/langsmith/smith-api/examples/validate-examples.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/examples/validate/bulk
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
components:
  schemas:
    ExampleValidationResult:
      ...
      description: >-
        Validation result for Example, combining fields from Create/Base/Update
        schemas.
  securitySchemes:
    API Key:
      type: apiKey
