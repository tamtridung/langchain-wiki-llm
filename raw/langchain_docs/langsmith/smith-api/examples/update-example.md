...
source: https://docs.langchain.com/langsmith/smith-api/examples/update-example.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /api/v1/examples/{example_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
