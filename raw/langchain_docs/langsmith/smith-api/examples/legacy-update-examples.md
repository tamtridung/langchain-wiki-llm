...
source: https://docs.langchain.com/langsmith/smith-api/examples/legacy-update-examples.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /api/v1/examples/bulk
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/examples/bulk:
    patch:
      ...
      description: >-
        Legacy update examples in bulk. For update involving attachments, use
        PATCH /v1/platform/datasets/{dataset_id}/examples instead.
