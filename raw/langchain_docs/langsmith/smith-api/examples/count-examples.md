...
source: https://docs.langchain.com/langsmith/smith-api/examples/count-examples.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/examples/count
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
