...
source: https://docs.langchain.com/langsmith/smith-api/examples/validate-example.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/examples/validate
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
