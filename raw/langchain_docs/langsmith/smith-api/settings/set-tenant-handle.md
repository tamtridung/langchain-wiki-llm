...
source: https://docs.langchain.com/langsmith/smith-api/settings/set-tenant-handle.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/settings/handle
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
