---
title: Invoke Prompt
source: https://docs.langchain.com/langsmith/smith-api/prompts/invoke-prompt.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/prompts/invoke_prompt
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
