...
source: https://docs.langchain.com/langsmith/smith-api/issues-agent/get-engine-lcu-consumed-during-the-free-trial.md
---
...
# Get Engine LCU consumed during the free trial
...
````yaml /langsmith/langsmith-platform-openapi.json get /v1/platform/engine/trial-lcu-total
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
tags:
  ...
  - name: fleet users
paths:
  /v1/platform/engine/trial-lcu-total:
    get:
      tags:
        - issues-agent
      summary: Get Engine LCU consumed during the free trial
      description: |-
        Returns the org-wide sum of priced Engine LCU consumed strictly
        before the GA cutoff (2026-06-01 UTC), i.e. all usage that was
        free, plus the count of projects that had Engine configured.
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/issues_agent_usage.TrialLCUTotalResponse'
        '400':
...
components:
  schemas:
    issues_agent_usage.TrialLCUTotalResponse:
      type: object
      properties:
        lcu_total:
          type: string
