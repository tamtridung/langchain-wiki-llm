...
source: https://docs.langchain.com/langsmith/smith-api/data_planes/list-data-planes-for-the-current-organization.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /orgs/current/data-planes
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /orgs/current/data-planes:
    get:
      ...
      responses:
        '200':
          description: Data planes
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/data_planes.ListPublicDataPlanesResponse'
        '400':
          ...
          content:
            application/json:
              schema:
                ...
                type: object
        '403':
          description: BYOC not enabled for this organization
          content:
            application/json:
              schema:
                additionalProperties:
...
components:
  schemas:
    data_planes.ListPublicDataPlanesResponse:
      type: object
      properties:
        data_planes:
          type: array
