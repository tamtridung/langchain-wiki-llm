...
source: https://docs.langchain.com/langsmith/smith-api/mcp_vendors/get-vendor-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /v1/platform/mcp-vendors/{vendor_slug}/settings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
