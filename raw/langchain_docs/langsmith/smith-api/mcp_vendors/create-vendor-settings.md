...
source: https://docs.langchain.com/langsmith/smith-api/mcp_vendors/create-vendor-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /v1/platform/mcp-vendors/{vendor_slug}/settings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /v1/platform/mcp-vendors/{vendor_slug}/settings:
    post:
      tags:
        - mcp_vendors
      summary: Create vendor settings
