---
title: Send Sso Email Confirmation
source: https://docs.langchain.com/langsmith/smith-api/auth/send-sso-email-confirmation.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/sso/email-verification/send
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                type: object
                title: >-
                  Response Send Sso Email Confirmation Api V1 Sso Email
