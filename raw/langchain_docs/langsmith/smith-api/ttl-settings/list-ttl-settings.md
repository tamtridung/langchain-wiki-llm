...
source: https://docs.langchain.com/langsmith/smith-api/ttl-settings/list-ttl-settings.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/ttl-settings
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
