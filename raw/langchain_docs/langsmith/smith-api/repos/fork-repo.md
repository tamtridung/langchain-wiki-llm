---
title: Fork Repo
source: https://docs.langchain.com/langsmith/smith-api/repos/fork-repo.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/repos/{owner}/{repo}/fork
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
