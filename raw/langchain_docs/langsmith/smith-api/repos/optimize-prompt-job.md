...
source: https://docs.langchain.com/langsmith/smith-api/repos/optimize-prompt-job.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/repos/optimize-job
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
