...
source: https://docs.langchain.com/langsmith/smith-api/tracer-sessions/read-filter-views.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/sessions/{session_id}/views
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Read Filter Views Api V1 Sessions  Session Id  Views
                  Get
        '422':
