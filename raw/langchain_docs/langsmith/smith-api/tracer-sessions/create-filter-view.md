...
source: https://docs.langchain.com/langsmith/smith-api/tracer-sessions/create-filter-view.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/sessions/{session_id}/views
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
