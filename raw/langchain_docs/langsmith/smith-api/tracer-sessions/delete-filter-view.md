...
source: https://docs.langchain.com/langsmith/smith-api/tracer-sessions/delete-filter-view.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/sessions/{session_id}/views/{view_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
