...
source: https://docs.langchain.com/langsmith/smith-api/tracer-sessions/read-tracer-sessions-runs-metadata.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/sessions/{session_id}/metadata
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/sessions/{session_id}/metadata:
    get:
      ...
      description: >-
        Given a session, a number K, and (optionally) a list of metadata keys,
        return the top K values for each key.
      operationId: >-
        read_tracer_sessions_runs_metadata_api_v1_sessions__session_id__metadata_get
      parameters:
        - name: session_id
          in: path
          required: true
