...
source: https://docs.langchain.com/langsmith/smith-api/tracer-sessions/update-tracer-session.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json patch /api/v1/sessions/{session_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
