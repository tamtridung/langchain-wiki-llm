...
source: https://docs.langchain.com/langsmith/smith-api/tracer-sessions/create-tracer-session.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/sessions
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
