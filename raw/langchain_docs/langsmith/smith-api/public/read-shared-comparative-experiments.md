...
source: https://docs.langchain.com/langsmith/smith-api/public/read-shared-comparative-experiments.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/public/{share_token}/datasets/comparative
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/public/{share_token}/datasets/comparative:
    get:
      ...
      operationId: >-
        read_shared_comparative_experiments_api_v1_public__share_token__datasets_comparative_get
      parameters:
        - name: share_token
          in: path
          required: true
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Read Shared Comparative Experiments Api V1 Public 
                  Share Token  Datasets Comparative Get
        '422':
