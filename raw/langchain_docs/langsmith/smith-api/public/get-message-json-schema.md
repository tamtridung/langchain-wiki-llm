...
source: https://docs.langchain.com/langsmith/smith-api/public/get-message-json-schema.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/public/schemas/{version}/message.json
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
