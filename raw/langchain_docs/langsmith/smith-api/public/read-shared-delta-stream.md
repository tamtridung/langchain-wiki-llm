...
source: https://docs.langchain.com/langsmith/smith-api/public/read-shared-delta-stream.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/public/{share_token}/datasets/runs/delta/stream
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
    ...
    post:
      ...
      description: |-
        ...
        Response format (SSE):
            ...
            event: end
      operationId: >-
        read_shared_delta_stream_api_v1_public__share_token__datasets_runs_delta_stream_post
      parameters:
        - name: share_token
          in: path
          required: true
...
components:
  schemas:
    QueryFeedbackDeltaBatch:
      ...
      description: >-
        Request schema for batched feedback delta queries with multiple feedback
        keys.
    HTTPValidationError:
      properties:
        detail:
