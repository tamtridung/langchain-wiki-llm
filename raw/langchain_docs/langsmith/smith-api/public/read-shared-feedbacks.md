...
source: https://docs.langchain.com/langsmith/smith-api/public/read-shared-feedbacks.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/public/{share_token}/feedbacks
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Read Shared Feedbacks Api V1 Public  Share Token 
                  Feedbacks Get
        '422':
