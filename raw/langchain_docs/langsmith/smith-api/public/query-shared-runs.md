...
source: https://docs.langchain.com/langsmith/smith-api/public/query-shared-runs.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/public/{share_token}/runs/query
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
