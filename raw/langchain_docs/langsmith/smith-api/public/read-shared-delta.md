---
title: Read Shared Delta
source: https://docs.langchain.com/langsmith/smith-api/public/read-shared-delta.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/public/{share_token}/datasets/runs/delta
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
