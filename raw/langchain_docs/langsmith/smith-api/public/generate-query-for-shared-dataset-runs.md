...
source: https://docs.langchain.com/langsmith/smith-api/public/generate-query-for-shared-dataset-runs.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/public/{share_token}/datasets/runs/generate-query
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/public/{share_token}/datasets/runs/generate-query:
    post:
      ...
      operationId: >-
        generate_query_for_shared_dataset_runs_api_v1_public__share_token__datasets_runs_generate_query_post
      parameters:
        - name: share_token
          in: path
          required: true
