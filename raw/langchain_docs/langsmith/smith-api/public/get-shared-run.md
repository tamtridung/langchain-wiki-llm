...
source: https://docs.langchain.com/langsmith/smith-api/public/get-shared-run.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/public/{share_token}/run
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
