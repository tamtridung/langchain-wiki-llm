...
source: https://docs.langchain.com/langsmith/smith-api/public/read-shared-examples.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/public/{share_token}/examples
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response Read Shared Examples Api V1 Public  Share Token 
                  Examples Get
        '422':
