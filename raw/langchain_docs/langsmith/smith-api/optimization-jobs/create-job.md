---
title: Create Job
source: https://docs.langchain.com/langsmith/smith-api/optimization-jobs/create-job.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/repos/{owner}/{repo}/optimization-jobs
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
