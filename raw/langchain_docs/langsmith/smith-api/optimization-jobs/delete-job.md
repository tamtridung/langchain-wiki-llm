---
title: Delete Job
source: https://docs.langchain.com/langsmith/smith-api/optimization-jobs/delete-job.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json delete /api/v1/repos/{owner}/{repo}/optimization-jobs/{job_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
