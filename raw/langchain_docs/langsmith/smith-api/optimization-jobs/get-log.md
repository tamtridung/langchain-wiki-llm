---
title: Get Log
source: https://docs.langchain.com/langsmith/smith-api/optimization-jobs/get-log.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/repos/{owner}/{repo}/optimization-jobs/{job_id}/logs/{log_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/repos/{owner}/{repo}/optimization-jobs/{job_id}/logs/{log_id}:
    get:
      ...
      operationId: >-
        get_log_api_v1_repos__owner___repo__optimization_jobs__job_id__logs__log_id__get
      parameters:
        - name: log_id
          in: path
          required: true
