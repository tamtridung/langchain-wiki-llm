---
title: Create Log
source: https://docs.langchain.com/langsmith/smith-api/optimization-jobs/create-log.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json post /api/v1/repos/{owner}/{repo}/optimization-jobs/{job_id}/logs
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/repos/{owner}/{repo}/optimization-jobs/{job_id}/logs:
    post:
      ...
      operationId: >-
        create_log_api_v1_repos__owner___repo__optimization_jobs__job_id__logs_post
      parameters:
        - name: job_id
          in: path
          required: true
