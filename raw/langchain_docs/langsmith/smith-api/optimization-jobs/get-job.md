---
title: Get Job
source: https://docs.langchain.com/langsmith/smith-api/optimization-jobs/get-job.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/repos/{owner}/{repo}/optimization-jobs/{job_id}
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
