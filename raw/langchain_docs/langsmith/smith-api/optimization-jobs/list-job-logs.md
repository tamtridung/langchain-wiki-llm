---
title: List Job Logs
source: https://docs.langchain.com/langsmith/smith-api/optimization-jobs/list-job-logs.md
---
...
````yaml /langsmith/langsmith-platform-openapi.json get /api/v1/repos/{owner}/{repo}/optimization-jobs/{job_id}/logs
openapi: 3.1.0
info:
  title: LangSmith
  description: >+
...
paths:
  /api/v1/repos/{owner}/{repo}/optimization-jobs/{job_id}/logs:
    get:
      ...
      operationId: >-
        list_job_logs_api_v1_repos__owner___repo__optimization_jobs__job_id__logs_get
      parameters:
        - name: job_id
          in: path
          required: true
          ...
          content:
            application/json:
              schema:
                ...
                title: >-
                  Response List Job Logs Api V1 Repos  Owner   Repo 
                  Optimization Jobs  Job Id  Logs Get
        '422':
