...
source: https://docs.langchain.com/langsmith/model-configurations.md
---
...
<Note>
  OAuth client credentials are available on LangSmith [Cloud](/langsmith/cloud). [Self-hosted](/langsmith/self-hosted) support is planned for an upcoming release.
</Note>
