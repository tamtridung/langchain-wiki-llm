...
source: https://docs.langchain.com/langsmith/data-plane.md
---
...
[`Production` type](/langsmith/cloud-platform-features#deployment-types) deployments automatically scale up to 10 containers. Scaling is based on 3 metrics:
