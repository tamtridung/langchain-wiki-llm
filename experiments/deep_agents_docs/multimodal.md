...
[​](#multimodal-user-input) Multimodal user input
-------------------------------------------------
...
[​](#built-in-read_file-tool) Built-in `read_file` tool
-------------------------------------------------------
...
[​](#context-compression-and-multimodal-content) Context compression and multimodal content
-------------------------------------------------------------------------------------------
...
Previous](https://docs.langchain.com/oss/python/deepagents/context-engineering)[Backends

Next](https://docs.langchain.com/oss/python/deepagents/backends)
