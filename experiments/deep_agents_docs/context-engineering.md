...
Custom instructions you provide plus built-in agent guidance.](#system-prompt)

[Memory
------

Persistent `AGENTS.md` files always loaded when configured.](#memory)

[Skills
------

On-demand capabilities loaded when relevant (progressive disclosure).](#skills)

[Tool prompts
------------

Instructions for using built-in tools or custom tools.](#tool-prompts)
...
Large tool inputs and results are stored in the filesystem and replaced with references.](#offloading)

[Summarization
-------------

Old messages are compressed into an LLM-generated summary when limits are approached.](#summarization)
...
[​](#context-isolation-with-subagents) Context isolation with subagents
-----------------------------------------------------------------------
...
Previous](https://docs.langchain.com/oss/python/deepagents/tools)[Multimodal inputs and outputs

Next](https://docs.langchain.com/oss/python/deepagents/multimodal)
