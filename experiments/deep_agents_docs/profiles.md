...
[​](#param-tool-description-overrides)

tool\_description\_overrides

Mapping[str, str]

Override individual tool descriptions, keyed by tool name.

[​](#param-excluded-tools)
...
[​](#param-general-purpose-subagent)
...
[​](#param-init-kwargs-factory)

init\_kwargs\_factory

Callable[[], dict[str, Any]]

Kwargs derived from runtime state (for example, headers pulled from environment variables).

[​](#load-profiles-from-config-files) Load profiles from config files
---------------------------------------------------------------------
...
[​](#ship-a-profile-as-a-plugin) Ship a profile as a plugin
-----------------------------------------------------------
...
Previous](https://docs.langchain.com/oss/python/deepagents/dynamic-subagents)[Event streaming

Next](https://docs.langchain.com/oss/python/deepagents/event-streaming)
